...
```
compile 'com.github.lewik.kouch:kouch-metadata:0.0.6' //for common modules
compile 'com.github.lewik.kouch:kouch-js:0.0.6'  //for js modules
compile 'com.github.lewik.kouch:kouch-jvm:0.0.6'  //for jvm modules
```
