...
```
compile 'com.github.lewik.kouch:kouch-metadata:0.0.9' //for common modules
//TODO compile 'com.github.lewik.kouch:kouch-js:0.0.9'  //for js modules
compile 'com.github.lewik.kouch:kouch-jvm:0.0.9'  //for jvm modules
```
